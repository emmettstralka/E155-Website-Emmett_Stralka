export const person = {
  ...
  degree: "Engineering major, Economics minor",
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Carnegie Mellon design-process work from 2021: cardboard packaging studies, CNC and wood furniture, and the boards that got them there.",
    href: "/creative",
    external: false,
  ...
  },
  {
    ...
    description:
      "Integrated Ford’s protobuf Vehicle Energy Model onto the V363 EV platform for 20,000+ E-Transit vans, validated against fleet telemetry, and tuned for usage patterns.",
    href: "/experience",
    external: false,
  ...
  },
  {
    ...
    description:
      "A Watch-to-iPhone-to-dashboard stack: HKWorkoutSession on wrist, WatchConnectivity in the background, FastAPI over WebSocket, and recovery metrics from HealthKit.",
    href: "https://github.com/emmettstralka/TeamPulse",
    external: true,
    image: "/images/teampulse-watch.png",
    alt: "Apple Watch showing a TeamPulse live athlete workout session",
  ...
  },
  {
    ...
    description:
      "A complete multicycle RISC-V controller and datapath — instruction decode, memory cycles, and control sequencing — from the personal systems portfolio.",
  ...
  },
  {
    ...
    alt: "E80 AUV with camera dome and thrusters submerged in a tiled pool",
  ...
  },
  {
    ...
    alt: "ROS 2 manipulator arm in a studio still",
...
export const creative = {
  kicker: "Creative",
  title: "Form, then the shop.",
  origin: "Carnegie Mellon University · Design process, 2021",
  description:
    "Work from a 2021 Carnegie Mellon design studio and the year around it: packaging that had to survive a grocery cart, furniture held together by cable, wood under a mill. These are process photographs and boards from that making — not a finished product line.",
} as const;
...
export const creativeWorks = [
  ...
  {
    src: "/creative/img-0362.jpg",
    alt: "Digital painting of a white-armored figure in a temple with an AR translation inset",
    caption: "Discovery",
    credit: "Archive",
    width: 2476,
    height: 1582,
  ...
  },
  {
    ...
    caption: "Cantilever study, marker",
    credit: "Archive",
    width: 5628,
    height: 3752,
  },
